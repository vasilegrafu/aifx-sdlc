...
# ----------------------------------------------------------------
class Program(BaseDatabaseModel):
    __tablename__ = 'program'
    __table_args__ = (
        Index('idx__program__code', 'code', unique=True),
        Index('idx__program__department_id', 'department_id'),
    )
    ...
    degree_level: Mapped[str] = mapped_column(String(8))
    duration_semesters: Mapped[int] = mapped_column(SmallInteger)
